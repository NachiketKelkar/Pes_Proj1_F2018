...
DESCRIPTION	:Function to write the pattern to the contents of memory in unsigned 32-bit hexadecimal format.
                 The user may specify an address, seed value and the number of 32bit words to write.
...
int write_pattern()
{
   ...
   {   
	 ...
	 break;
      ...
      //printf("Enter the address on which you want to write the contents\n>>");
      //scanf("%p",&address);
	 ...
	 printf("Write Pattern successful\n");
         printf("Time taken to perform write pattern =%f seconds\n",(double)(second-first)*1000/CLOCKS_PER_SEC); // The time taken to perform write_pattern
